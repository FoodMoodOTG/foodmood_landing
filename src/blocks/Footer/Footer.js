        ...
        <div className={styles.wrp}>
          <div className={styles.column}>
            ...
            <ul className={styles.links}>
              <li onClick={(e) => linkClick(e, 'features', '/#features')}>Features</li>
              <li onClick={(e) => linkClick(e, 'betefits', '/#features')}>Benefits</li>
              <li onClick={(e) => linkClick(e, 'reviews', '/#reviews')}>How It Works</li>
              <li onClick={(e) => linkClick(e, 'form', '/#features')}>Contacts</li>
            </ul>
          </div>
